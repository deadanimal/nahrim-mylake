...
class MapService {
    ...
    loadAndAddImage(imageId, url, options) {
        return __awaiter(this, void 0, void 0, /** @this {!MapService} */ function* () {
            return this.zone.runOutsideAngular((/**
             * @return {?}
             */
            () => {
...
class GeoJSONSourceComponent {
    ...
    getClusterExpansionZoom(clusterId) {
        return __awaiter(this, void 0, void 0, /** @this {!GeoJSONSourceComponent} */ function* () {
            /** @type {?} */
            const source = this.MapService.getSource(this.id);
            return this.zone.run((/**
             * @return {?}
             */
            () => __awaiter(this, void 0, void 0, /** @this {!GeoJSONSourceComponent} */ function* () {
                return new Promise((/**
                 * @param {?} resolve
                 * @param {?} reject
                 * @return {?}
...
class ImageComponent {
     ...
     */
    init() {
        return __awaiter(this, void 0, void 0, /** @this {!ImageComponent} */ function* () {
            this.isAdding = true;
            if (this.data) {
...
class MapComponent {
     ...
     */
    ngOnChanges(changes) {
        return __awaiter(this, void 0, void 0, /** @this {!MapComponent} */ function* () {
