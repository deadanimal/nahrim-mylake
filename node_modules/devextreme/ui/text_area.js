...
var TextArea = TextBox.inherit({
    ...
    _getHeightDifference: function($input) {
        return sizeUtils.getVerticalOffsets(this._$element.get(0), false) + sizeUtils.getVerticalOffsets(this._$textEditorContainer.get(0), false) + sizeUtils.getVerticalOffsets(this._$textEditorInputContainer.get(0), false) + sizeUtils.getElementBoxParams("height", window.getComputedStyle($input.get(0))).margin
    },
